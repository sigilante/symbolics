...
complete, and both interfaces are frozen.  324 tests green.  Jets are
next.**
...
|---|---|---|---|---:|
| **Racoon** | complete, frozen | deferred | in progress — see below | 218 |
...
is built, real-root isolation is specified (`raccoon-spec.md` §R) with its
phase R0 built, and van Hoeij recombination and sparse multivariate remain
unspecified.
...
racoon/
  desk/
    ...
    lib/racoon-roots.hoon       exact real-root counting (Sturm)
...
The `*-fmt`, `racoon-rs`, `racoon-fp3`, `racoon-zfac`, and `racoon-roots`
libraries are **consumers**: they
